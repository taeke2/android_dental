...
public class MessageService extends FirebaseMessagingService {
    ...
    public void onMessageReceived(@NonNull RemoteMessage remoteMessage) {
        // 로그아웃 시 알람받지않도록
        if (getSharedPreferences("auto", MODE_PRIVATE).getString("id", "").equals(""))
            return;
        ...
        if (remoteMessage.getData().size() > 0) {
            ...
            Log.d("testttt", "type, title, body : " + type + ", " + title + ", " + body);
            switch (type) {
                case "notice_imp" :
                    CommonClass.sNotificationNoticeId++;
                    showNotificationNotice(type, title, body);
                    break;
                case "client_ref" :
                    CommonClass.sNotificationClientId++;
                    showNotificationClient(type, title, body);
                    break;
                case "request" :
                    CommonClass.sNotificationRequestId++;
                    showNotificationRequest(type, title, body);
                    break;
                case "material_low" :
                    CommonClass.sNotificationMaterialId++;
                    showNotificationMaterial(type, title, body);
                    break;
                case "equip_err" :
                    CommonClass.sNotificationEquipErrId++;
                    showNotificationEquip(type, title, body);
                    break;
                default :
                    break;
            }
...
//        }
    ...
    public void showNotificationNotice(String type, String title, String message) {
        String channel_id = "CHN_NOTICE";
        String channel_name = "공지사항 알람";
        String group_key = "groupKey_notice";
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(getApplicationContext(), channel_id)
                ...
                .setContentIntent(getPendingIntent(type))
                .setSmallIcon(R.drawable.icon_warn_1x)
                .setGroup(group_key);

        notificationManager.notify(CommonClass.sNotificationNoticeId, builder.build());

        Notification notification = new NotificationCompat.Builder(getApplicationContext(), channel_id)
                .setContentTitle("genty 알람")
                .setContentText("공지사항 알람")
                .setSmallIcon(R.drawable.icon_warn_1x)
                .setStyle(new NotificationCompat.InboxStyle()
                        .setSummaryText("공지사항 알람"))
                .setGroup(group_key)
                .setAutoCancel(true)
    ...
    public void showNotificationClient(String type, String title, String message) {
        String channel_id = "CHN_CLIENT";
        String channel_name = "거래처 알람";
        String group_key = "groupKey_client";
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(getApplicationContext(), channel_id)
                ...
                .setContentText(message)
                .setContentIntent(getPendingIntent(type))
                .setSmallIcon(R.drawable.icon_info_1x)
                .setGroup(group_key);

        notificationManager.notify(CommonClass.sNotificationClientId, builder.build());

        Notification notification = new NotificationCompat.Builder(getApplicationContext(), channel_id)
                .setContentTitle("genty 알람")
                .setContentText("거래처 알람")
                .setSmallIcon(R.drawable.icon_info_1x)
                .setStyle(new NotificationCompat.InboxStyle()
                        .setSummaryText("거래처 알람"))
                .setGroup(group_key)
                .setAutoCancel(true)
                .setGroupSummary(true)
                .build();
    ...
    public void showNotificationRequest(String type, String title, String message) {
        String channel_id = "CHN_REQUEST";
        String channel_name = "의뢰서등록 알람";
        String group_key = "groupKey_request";
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(getApplicationContext(), channel_id)
                ...
                .setContentText(message)
                .setContentIntent(getPendingIntent(type))
                .setSmallIcon(R.drawable.icon_bell_1x)
                .setGroup(group_key);

        notificationManager.notify(CommonClass.sNotificationRequestId, builder.build());

        Notification notification = new NotificationCompat.Builder(getApplicationContext(), channel_id)
                .setContentTitle("genty 알람")
                .setContentText("의뢰서등록 알람")
                .setSmallIcon(R.drawable.icon_bell_1x)
                .setStyle(new NotificationCompat.InboxStyle()
                        .setSummaryText("의뢰서등록 알람"))
                .setGroup(group_key)
                .setAutoCancel(true)
                .setGroupSummary(true)
                .build();
    ...
    public void showNotificationMaterial(String type, String title, String message) {
        String channel_id = "CHN_MATERIAL";
        String channel_name = "재고부족 알람";
        String group_key = "groupKey_material";
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(getApplicationContext(), channel_id)
                ...
                .setContentText(message)
                .setContentIntent(getPendingIntent(type))
                .setSmallIcon(R.drawable.icon_warn2_1x)
                .setGroup(group_key);

        notificationManager.notify(CommonClass.sNotificationMaterialId, builder.build());

        Notification notification = new NotificationCompat.Builder(getApplicationContext(), channel_id)
                .setContentTitle("genty 알람")
                .setContentText("재고부족 알람")
                .setSmallIcon(R.drawable.icon_warn2_1x)
                .setStyle(new NotificationCompat.InboxStyle()
                        .setSummaryText("재고부족 알람"))
                .setGroup(group_key)
                .setAutoCancel(true)
                .setGroupSummary(true)
                .build();
    ...
    public void showNotificationEquip(String type, String title, String message) {
        String channel_id = "CHN_EQUIP";
        String channel_name = "장비 알람";
        String group_key = "groupKey_equip";
        ...
        notificationManager.notify(CommonClass.sNotificationEquipErrId, builder.build());

        Notification notification = new NotificationCompat.Builder(getApplicationContext(), channel_id)
                .setContentTitle("genty 알람")
                .setContentText("장비 알람")
                .setSmallIcon(R.drawable.icon_emergency_1x)
                .setStyle(new NotificationCompat.InboxStyle()
                        .setSummaryText("장비 알람"))
                .setGroup(group_key)
                .setAutoCancel(true)
                .setGroupSummary(true)
                .build();
...
//        switch (type) {
//            case "work":
//                Common.startLocationService(com.gbsoft.ellosseum.MessageService.this, Common.isLocationServiceRunning(com.gbsoft.ellosseum.MessageService.this));
...
//                Common.stopLocationService(com.gbsoft.ellosseum.MessageService.this, Common.isLocationServiceRunning(com.gbsoft.ellosseum.MessageService.this));
//                break;
//        }
//
//        buildNotification(
...
//        Common.stopLocationService(getApplicationContext(), Common.isLocationServiceRunning(com.gbsoft.ellosseum.MessageService.this));
//        Intent intent = new Intent(com.gbsoft.ellosseum.MessageService.this, AuthorizationActivity.class);
