...
public class DynamicNewLine {
        ...
        public void getNewLineLayout(final String[] str, final int fontSize, final Context context, final RequestDetailAdapter_YK.MyViewHolder holder, final ViewGroup parent, float scale) {
                    ...
                    if(parent.getWidth() != 0) {
                        ...
                        for (int i = 0; i < linearBox.length; i++) {
                            ...
                            if(i > 0){ // 해시태그 이미지 때문에 간격 맞추기 위해 추가
                                params.setMargins(space, space, 0, space);
                            } else {
